package net.sxkeji.shixinandroiddemo2.views;
 ...
 */
public class BaseRecyclerView<T extends RecyclerView.Adapter> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
	 ...
	 * 		the adapter to wrap
	 */
	public BaseRecyclerView(T base) {
		super();
		mBase = base;
	}
