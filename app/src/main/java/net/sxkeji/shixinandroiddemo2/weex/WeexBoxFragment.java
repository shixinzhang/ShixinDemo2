...
public class WeexBoxFragment extends WeexBaseFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mWXSDKInstance.render("WXSample", WXFileUtils.loadAsset("weex/hello_weex.js", getContext()), null, null, WXRenderStrategy.APPEND_ASYNC);
    }
