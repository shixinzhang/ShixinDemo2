...
public class WeexTextareaFragment extends WeexBaseFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mWXSDKInstance.render("WXSample", WXFileUtils.loadAsset("weex/textarea.js", getContext()), null, null, WXRenderStrategy.APPEND_ASYNC);
    }
